<?php
// api/chat/upload_image.php - Uploader une image pour le chat
...
$upload_dir = dirname(__DIR__, 2) . '/uploads/messages/';
...
$filename = 'msg_' . time() . '_' . bin2hex(random_bytes(8)) . '.' . $extension;
